...
export const __Iterator__ = globalThis.Object.getPrototypeOf(__Generator__);
...
export const __AsyncIterator__ = globalThis.Object.getPrototypeOf(__AsyncGenerator__);
// Dummy constructor to allow use in "extends"
